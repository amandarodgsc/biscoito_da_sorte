...
export default function App() {
  const [img, setImg] = useState(require("../biscoito_da_sorte/assets/biscoitoaberto.jpeg"));
  ...
  function quebraBiscoito() {
    ...
    setImg(require("../biscoito_da_sorte/assets/biscoitoaberto.jpeg"));
  }

  function reiniciarBiscoito() {
    setImg(require("../biscoito_da_sorte/assets/biscoitofechado.jpeg"));
    setTextFrase("");
  }
